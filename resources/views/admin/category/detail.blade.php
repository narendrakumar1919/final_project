    ...
    <div class="bg-pattern bg-black-op-25" style="background-image: url('assets/media/various/bg-pattern.png');">
        ...
        <div class="bg-pattern bg-black-op-25" style="background-image: url('assets/media/various/bg-pattern.png');">
            <div class="content content-top text-center">
                <div class="py-50">
                    <h1 class="font-w700 text-white mb-10">Categories</h1>
                    <h2 class="h4 font-w400 text-white-op">Category Detail</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="mb-50">
                    ...
                    <div class="text-muted mb-10">
                        ...
                        <a class="text-muted mr-15" href="#">
                            <i class="fa fa-fw fa-user mr-5"></i>{{$show->category_name}}
                        </a>
